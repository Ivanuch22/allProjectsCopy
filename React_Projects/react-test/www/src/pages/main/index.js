  ...
  return (
    <>
      ...
      <div className='content__main'>
        {isLoading ? <NoLoadedCard /> : input.length > 0 ? searchedCards.length > 0 ? renderCards(searchedCards, false) : <h2 className='nothingFound'>Нічого не знайдено</h2> : renderCards(items, false)}
      </div>
    </>
