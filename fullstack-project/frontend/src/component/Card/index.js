  ...
  return (
    <>
      <div className={style.card} >
        ...
        <div onClick={() => like()} style={obj.isLike ? { background: "#FEF0F0" } : { background: "transparent" }} className={`${style.like} ${style.button}`}>
          {obj.isLike ?
        ...
        <div onClick={() => add()} style={obj.isAdded ? { background: "linear-gradient(180deg, #89F09C 0%, #3CC755 100%)" } : { background: "transparent" }} className={`${style.add} ${style.button}`} >
          {obj.isAdded ?
